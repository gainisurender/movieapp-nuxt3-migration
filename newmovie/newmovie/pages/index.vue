<template>
  <div class="home">
    ...
    <div class="container search">
      <input type="text" placeholder="Search" @keyup.enter="fetchMovies" v-model.lazy="searchInput" />
    ...
    <div v-else class="container movies">
      <!-- Search Results -->
      <div id="movie-grid" v-if="searchInput !== ''" class="movies-grid search-grid">
        <div class="movie" v-for="movie in searchedMovies" :key="movie.id">
          ...
          <div class="info">
            ...
            <NuxtLink class="button button-light" :to="{ path: 'movies/' + movie.id }">
              Get More Info
            </NuxtLink>
          </div>
        </div>
...
import { ref } from 'vue';
import { MovieItem, MovieResponseRoot } from '~~/types/movie';
...
const getMovies = async () => {
  const data = await $fetch<MovieResponseRoot>(
...
await useAsyncData(fetchMovies);
